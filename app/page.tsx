...
export default function Home() {
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center px-5 pb-10 pt-6 [background:var(--page-glow)]">
      ...
      <footer className="mt-auto flex flex-col items-center gap-4 pt-14">
        <a
          className="inline-flex items-center gap-2 rounded-full border border-hairline-strong bg-surface px-5 py-2.5 text-sm font-semibold text-ink shadow-sm transition-all hover:-translate-y-px hover:border-brand hover:text-brand"
          href={DONATE_URL}
          target="_blank"
